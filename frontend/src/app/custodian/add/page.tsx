...
import type { Custodian } from "@/library/types"
...
export default function addCustodian() {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // Todo: Must throw error case if for some reason user puts in too much numbers as their input. Maximum input is 10 numbers
                    ...
                    <div className="p-8 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                            <div>
                                ...
                                <input type="text" name="firstname" id="firstname" value={custodian.name} onChange={(e) => setCustodian({ ...custodian, name: e.target.value })} className="bg-gray-50 border border-gray-300 text-gray-900 rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Full Name" />
                            </div>
                            <div>
                            ...
                            <button type="submit" className="w-full text-white bg-green-800 hover:bg-green-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center disabled:cursor-progress disabled:bg-green-500">Add Custodian</button>
